...
<?php   
    $db = getDB();
    $stmt = $db->prepare("SELECT OrderItems.id, order_id, product_id, unit_price, OrderItems.quantity, name From OrderItems JOIN Products Where order_id=:order_id LIMIT 10");
